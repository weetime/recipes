...
Qwen3-4B is a 4B-parameter dense model with hybrid thinking / non-thinking modes
and a 40K-token context window. This guide covers serving the BF16 checkpoint
with **SGLang**.
...
The BF16 checkpoint (~9 GB weights) fits comfortably on a single H200 or B200
at `tp 1`.
