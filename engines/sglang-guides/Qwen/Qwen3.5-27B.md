...
Qwen3.5-27B is the flagship dense multimodal model in the Qwen3.5 family with
gated delta networks hybrid attention, MTP, and a 262K context. This guide
...
docker run --gpus all --ipc=host -p 30000:30000 \
  ...
  lmsysorg/sglang:dev \
  python3 -m sglang.launch_server --model-path Qwen/Qwen3.5-27B \
