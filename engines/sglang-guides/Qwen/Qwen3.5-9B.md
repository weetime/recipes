...
Qwen3.5-9B is a dense multimodal model in the Qwen3.5 family with gated delta
networks hybrid attention, MTP, and a 262K context — sized for single-GPU
serving. This guide covers serving the BF16 checkpoint with **SGLang**.
...
docker run --gpus all --ipc=host -p 30000:30000 \
  ...
  lmsysorg/sglang:dev \
  python3 -m sglang.launch_server --model-path Qwen/Qwen3.5-9B \
...
At ~20 GB of weights it fits on a single 24 GB GPU at `tp 1`.
