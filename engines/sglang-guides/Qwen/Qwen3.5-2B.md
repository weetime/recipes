...
Qwen3.5-2B is the mini dense multimodal member of the Qwen3.5 family — a
gated-delta-networks hybrid model with a 262K context for edge / low-VRAM
...
docker run --gpus all --ipc=host -p 30000:30000 \
  ...
  lmsysorg/sglang:dev \
  python3 -m sglang.launch_server --model-path Qwen/Qwen3.5-2B \
...
At ~5 GB of weights it fits on an 8 GB GPU at `tp 1`.
