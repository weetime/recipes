...
Qwen3.5-0.8B is the tiny dense multimodal member of the Qwen3.5 family — a
gated-delta-networks hybrid model with a 262K context, built for edge / draft
...
At ~2 GB of weights it runs on a single GPU at `tp 1`.
