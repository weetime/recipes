...
Qwen3.5-4B is the compact dense multimodal member of the Qwen3.5 family — a
gated-delta-networks hybrid model with a 262K context that fits on 16 GB
consumer GPUs. This guide covers serving the BF16 checkpoint with **SGLang**.
...
At ~9 GB of weights it fits on a single 16 GB GPU at `tp 1`.
